...
_orchestrator: ValuationOrchestrator | None = None
...
class ValuationRequest(BaseModel):
    ...
    wacc_override: float | None = Field(default=None, ge=0.04, le=0.30)
    terminal_growth_rate: float | None = Field(default=None, ge=0.001, le=0.05)
